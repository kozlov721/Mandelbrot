...
inline void MandelbrotSet::fill_with_color(uint8_t *pixels, int iters, int index) const {
...
std::string MandelbrotSet::get_params_info() const {
...
int MandelbrotSet::get_num_params() const {
    return 4;
}

void MandelbrotSet::change_param(int param_index, bool fast, int direction) {
